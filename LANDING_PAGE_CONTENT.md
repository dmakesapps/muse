# Muse — Landing Page Content

All required text for App Store approval. Each section should be its own page (or clearly separated section) on museapp.us.
...
Need help with Muse? We're here for you.
...
All your data is stored locally on your device. Simply uninstall the Muse app to remove all data. No data is stored on external servers.

**How do daily limits work?**
To keep the app free and sustainable, AI-powered features have daily limits that reset at midnight:
- Chat messages: 25 per day
- AI affirmation generations: 5 per day
- Journal AI insights: 3 per day

All non-AI features (breathwork, frequencies, journaling, saving favorites, etc.) are unlimited.

**Is my data private?**
Yes. All your personal data (journal entries, saved affirmations, progress, preferences) is stored locally on your device. We do not have access to it. When you use AI features, your messages are processed by third-party AI services (OpenRouter/Google Gemini for chat, OpenAI for text-to-speech) — please refer to our Privacy Policy for details.

**Is Muse a replacement for therapy?**
No. Muse is a wellness and mindfulness tool designed for informational, educational, and entertainment purposes. It is not a medical device and does not provide medical advice. If you are experiencing a mental health crisis, please contact 988 (Suicide & Crisis Lifeline) or text HOME to 741741 (Crisis Text Line).

**How do I turn off notifications?**
Go to the Progress screen (tap the fire/streak icon) → Notification Settings. You can customize or disable all notifications from there, or through your device's Settings → Notifications → Muse.

**What devices are supported?**
Muse requires iOS 17 or later and is available on iPhone and iPad.
